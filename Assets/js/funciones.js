  ...
  tblPlanCli = $("#tblPlanCli").DataTable({
    ...
    createdRow: function (row, data, index) {
      ...
      if (data.fecha_venc < data.fecha_actual) {
        $("td", row)
          .eq(6)
          .html('<span class="badge bg-danger">' + data.fecha_venc + "</span>");
      }
      if (data.fecha_venc < data.fecha_actual) {
        $("td", row).css({
...
function frmUsuario() {
  document.getElementById("title").textContent = "Agregar nuevo usuario";
...
//Fin Usuarios
function frmCliente() {
  document.getElementById("title").textContent = "Agregar nuevo miembro";
  document.getElementById("btnAccion").textContent = "Agregar";
...
function btnEditarCli(id) {
  document.getElementById("title").textContent = "Editar miembro";
  document.getElementById("btnAccion").textContent = "Guardar cambios";
...
function frmPlan() {
  document.getElementById("title").textContent = "Agregar nueva membresia";
  document.getElementById("btnAccion").textContent = "Agregar";
...
//rutinas
function frmRutina() {
  document.getElementById("title").textContent = "Agregar nueva Rutina";
  document.getElementById("btnAccion").textContent = "Agregar";
  document.getElementById("formulario").reset();
  document.getElementById("id").value = "";
  $("#myModal").modal("show");
...
//entrenador
function frmEnt() {
  document.getElementById("title").textContent = "Agregar nuevo entrenador";
  document.getElementById("btnAccion").textContent = "Agregar";
  document.getElementById("formulario").reset();
  document.getElementById("id").value = "";
  $("#myModal").modal("show");
          ...
          datasets: [
            {
              ...
              backgroundColor: ["rgb(255, 202, 240)"],
            },
          ],
        },
        options: {
